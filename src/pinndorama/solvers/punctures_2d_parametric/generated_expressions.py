...
def equal_spin_source_terms_numpy(
    xx0: Any,
    xx1: Any,
    equal_spin_sz: Any,
    xx2: Any = 0.0,
    *,
    ...
    """Evaluate sources with raw Bowen-York ``S0_z=S1_z=equal_spin_sz``."""

    overrides = {} if physics is None else dict(physics)
    overrides.update(
        {
            "AMAX": AMAX,
            "bScale": bScale,
    ...
    return source_terms_numpy(xx0, xx1, xx2, **overrides)


def equal_spin_source_terms_jax(
    xx0: Any,
    xx1: Any,
    equal_spin_sz: Any,
    xx2: Any = 0.0,
    *,
    ...
    """JAX source interface for raw Bowen-York equal axial spins."""
    ...
    return source_terms_jax(xx0, xx1, xx2, **overrides)
