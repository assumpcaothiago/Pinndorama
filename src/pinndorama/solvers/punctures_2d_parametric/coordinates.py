...
def native_collocation_grid(
    *,
    ...
    """Return flattened native-coordinate collocation points."""

    xx0 = xp.linspace(xx0_min, xx0_max, Nxx0)
    xx1 = xp.linspace(xx1_min, xx1_max, Nxx1)
...
def theta_inner_parity_samples(
    *,
    ...
    xx0 = xp.linspace(xx0_min, xx0_max, Nxx0)
    delta = xp.linspace(delta_min, delta_max, Ndelta)
