"""Portable, atomic NPZ checkpoints for dense publication models."""
...
def load_checkpoint(
    ...
    """Load and structurally validate a publication checkpoint."""

    checkpoint_path = Path(path)
    if checkpoint_path.suffix != ".npz":
        raise CheckpointError("only publication .npz checkpoints are supported")
    try:
