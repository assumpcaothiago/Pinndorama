...
#include "../set_CodeParameters.h"
  ...
  char filename[256];
  sprintf(filename, "out1d-z-n-%08d.txt", nn);
  ...
  // Define points for output along the z-axis in SinhSymTP coordinates.
...
#pragma omp parallel for
  ...
  fclose(outfile);
} // END FUNCTION diagnostics_nearest_1d_z_axis__rfm__SinhSymTP
