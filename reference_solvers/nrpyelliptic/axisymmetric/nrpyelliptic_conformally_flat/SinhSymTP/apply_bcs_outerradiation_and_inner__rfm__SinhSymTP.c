...
static inline REAL FD1_arbitrary_upwind_x0_dirn(const params_struct *restrict params, const REAL *restrict gf, const int i0, const int i1,
  ...
  switch (offset) {
  case 0: {
    static const REAL Rational_decl__1_60 = 1.0 / 60.0;
    static const REAL Rational_decl__3_20 = 3.0 / 20.0;
    static const REAL Rational_decl__3_4 = 3.0 / 4.0;
  ...
  case 1: {
    static const REAL Rational_decl__1_30 = 1.0 / 30.0;
    static const REAL Rational_decl__2_5 = 2.0 / 5.0;
    static const REAL Rational_decl__7_12 = 7.0 / 12.0;
    static const REAL Rational_decl__4_3 = 4.0 / 3.0;
    static const REAL Rational_decl__1_2 = 1.0 / 2.0;
    static const REAL Rational_decl__2_15 = 2.0 / 15.0;
    static const REAL Rational_decl__1_60 = 1.0 / 60.0;
  ...
  case 2: {
    static const REAL Rational_decl__1_6 = 1.0 / 6.0;
    static const REAL Rational_decl__77_60 = 77.0 / 60.0;
    static const REAL Rational_decl__5_2 = 5.0 / 2.0;
    static const REAL Rational_decl__5_3 = 5.0 / 3.0;
    static const REAL Rational_decl__5_6 = 5.0 / 6.0;
    static const REAL Rational_decl__1_4 = 1.0 / 4.0;
    static const REAL Rational_decl__1_30 = 1.0 / 30.0;
  ...
  case 3: {
    static const REAL Rational_decl__49_20 = 49.0 / 20.0;
    static const REAL Rational_decl__6_1 = 6;
    static const REAL Rational_decl__15_2 = 15.0 / 2.0;
    static const REAL Rational_decl__20_3 = 20.0 / 3.0;
    static const REAL Rational_decl__15_4 = 15.0 / 4.0;
    static const REAL Rational_decl__6_5 = 6.0 / 5.0;
    static const REAL Rational_decl__1_6 = 1.0 / 6.0;
 ...
 * Compute 1st derivative finite-difference derivative with arbitrary upwind
 */
static inline REAL FD1_arbitrary_upwind_x1_dirn(const params_struct *restrict params, const REAL *restrict gf, const int i0, const int i1,
                                                const int i2, const int offset) {
  MAYBE_UNUSED int const Nxx_plus_2NGHOSTS0 = params->Nxx_plus_2NGHOSTS0;
  MAYBE_UNUSED int const Nxx_plus_2NGHOSTS1 = params->Nxx_plus_2NGHOSTS1;
  MAYBE_UNUSED int const Nxx_plus_2NGHOSTS2 = params->Nxx_plus_2NGHOSTS2;
  REAL const invdxx1 = params->invdxx1;
  switch (offset) {
  case 0: {
    static const REAL Rational_decl__1_60 = 1.0 / 60.0;
    static const REAL Rational_decl__3_20 = 3.0 / 20.0;
...
} // END FUNCTION apply_bcs_outerradiation_and_inner__rfm__SinhSymTP
