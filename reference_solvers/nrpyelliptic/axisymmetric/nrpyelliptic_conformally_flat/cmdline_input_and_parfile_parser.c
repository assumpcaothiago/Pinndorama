...
#include <stdbool.h>
#include <string.h>
#define NUM_PARAMETERS 28 // Define the number of parameters
...
param_descriptor param_table[] = {{"CFL_FACTOR", 0, PARAM_REAL, 0, 0},
                                  ...
                                  {"diagnostics_output_every", 18, PARAM_INT, 0, 0},
    ...
    if (p) {
      ...
      if (p) {
        ...
        if (param_desc->index == 0) {
          ...
          read_integer(values_array[0], &commondata->diagnostics_output_every, "diagnostics_output_every");
        }
