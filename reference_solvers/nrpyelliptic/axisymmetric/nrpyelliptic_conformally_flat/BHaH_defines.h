...
typedef struct __commondata_struct__ {
  ...
  REAL MINIMUM_GLOBAL_WAVESPEED; // (nrpy.equations.nrpyelliptic.CommonParams)
  REAL P0_x;                     // (nrpy.equations.nrpyelliptic.CommonParams)
  REAL P0_y;                     // (nrpy.equations.nrpyelliptic.CommonParams)
  REAL P0_z;                     // (nrpy.equations.nrpyelliptic.CommonParams)
  REAL P1_x;                     // (nrpy.equations.nrpyelliptic.CommonParams)
  REAL P1_y;                     // (nrpy.equations.nrpyelliptic.CommonParams)
  REAL P1_z;                     // (nrpy.equations.nrpyelliptic.CommonParams)
  REAL S0_x;                     // (nrpy.equations.nrpyelliptic.CommonParams)
  REAL S0_y;                     // (nrpy.equations.nrpyelliptic.CommonParams)
  REAL S0_z;                     // (nrpy.equations.nrpyelliptic.CommonParams)
  REAL S1_x;                     // (nrpy.equations.nrpyelliptic.CommonParams)
  REAL S1_y;                     // (nrpy.equations.nrpyelliptic.CommonParams)
  REAL S1_z;                     // (nrpy.equations.nrpyelliptic.CommonParams)
  REAL bare_mass_0;              // (nrpy.equations.nrpyelliptic.CommonParams)
  REAL bare_mass_1;              // (nrpy.equations.nrpyelliptic.CommonParams)
  ...
  REAL eta_damping;              // (nrpy.equations.nrpyelliptic.CommonParams)
  REAL log10_current_residual;   // (nrpy.infrastructures.BHaH.nrpyelliptic.diagnostics)
  REAL log10_residual_tolerance; // (nrpy.infrastructures.BHaH.nrpyelliptic.diagnostics)
  ...
  int nn_max;                    // (nrpy.infrastructures.BHaH.nrpyelliptic.diagnostics)
...
typedef struct __rfmstruct__ {
  ...
  REAL *restrict f2_of_xx0;
  REAL *restrict f2_of_xx0__D0;
  REAL *restrict f2_of_xx0__DD00;
  REAL *restrict f4_of_xx1;
  REAL *restrict f4_of_xx1__D1;
  REAL *restrict f4_of_xx1__DD11;
} rfm_struct;
