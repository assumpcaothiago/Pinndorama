MAYBE_UNUSED const REAL AMAX = params.AMAX;                             // nrpy.reference_metric::AMAX
...
MAYBE_UNUSED const REAL bScale = params.bScale;                         // nrpy.reference_metric::bScale
...
MAYBE_UNUSED const REAL CFL_FACTOR = commondata.CFL_FACTOR;             // nrpy.infrastructures.BHaH.MoLtimestepping.register_all::CFL_FACTOR
...
MAYBE_UNUSED const REAL dt = commondata.dt;                   // nrpy.infrastructures.BHaH.MoLtimestepping.register_all::dt
...
MAYBE_UNUSED const bool is_host = params.is_host; // nrpy.infrastructures.BHaH.rfm_precompute::is_host
...
MAYBE_UNUSED const int nn = commondata.nn;             // nrpy.infrastructures.BHaH.MoLtimestepping.register_all::nn
MAYBE_UNUSED const int nn_0 = commondata.nn_0;         // nrpy.infrastructures.BHaH.MoLtimestepping.register_all::nn_0
...
char outer_bc_type[50]; // nrpy.infrastructures.BHaH.CurviBoundaryConditions.register_all::outer_bc_type
{
  // Safely copy string with snprintf, which guarantees null termination
...
MAYBE_UNUSED const REAL SINHWAA = params.SINHWAA;                     // nrpy.reference_metric::SINHWAA
MAYBE_UNUSED const REAL SQRT1_2 = params.SQRT1_2;                     // nrpy.reference_metric::SQRT1_2
MAYBE_UNUSED const bool stop_relaxation = commondata.stop_relaxation; // nrpy.infrastructures.BHaH.nrpyelliptic.stop_conditions_check::stop_relaxation
MAYBE_UNUSED const REAL t_0 = commondata.t_0;                         // nrpy.infrastructures.BHaH.MoLtimestepping.register_all::t_0
MAYBE_UNUSED const REAL t_final = commondata.t_final;                 // nrpy.infrastructures.BHaH.MoLtimestepping.register_all::t_final
MAYBE_UNUSED const REAL time = commondata.time;                       // nrpy.infrastructures.BHaH.MoLtimestepping.register_all::time
