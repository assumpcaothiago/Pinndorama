...
void params_struct_set_to_default(commondata_struct *restrict commondata, griddata_struct *restrict griddata) {
  ...
  for (int grid = 0; grid < commondata->NUMGRIDS; grid++) {
    ...
    params->AMAX = 1000000.0;                           // nrpy.reference_metric::AMAX
    ...
    params->SINHWAA = 0.07;                             // nrpy.reference_metric::SINHWAA
    params->SQRT1_2 = 0.707106781186547524400844362105; // nrpy.reference_metric::SQRT1_2
    params->bScale = 5.0;                               // nrpy.reference_metric::bScale
    ...
    params->is_host = true;                             // nrpy.infrastructures.BHaH.rfm_precompute::is_host
